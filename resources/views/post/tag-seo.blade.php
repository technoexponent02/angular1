<?php
//$arr 		= explode('-', strtolower($tag_name));
//$tag_name	= ucwords(implode(' ', $arr));
?>
@extends('seo.public')
...
@section('titleMetaTag')
	<title>{{ $tag_name  }} | SWOLK</title>
	<meta name="description" content="{{ $featured_image_post['short_description'] }}"/>
	<meta property="og:title" content="{{ "$tag_name | SWOLK" }}" />
	<meta property="og:type" content="" />
	<meta property="og:url" content="{{ url($tag_url) }}" />
	<meta property="og:image" content="{{ isset($featured_image_post['image']) ? $featured_image_post['image'] : "" }}" />
	<meta property="og:description" content="{{ $featured_image_post['short_description'] }}" />
@endsection
										...
										<div class="pickCatrgorySlider">
											<div class="" style="display:block;">
												<div class="owl-carousel categorySlider">
													...
													?>
														<div class="item">
															<a class="catgBx" href="/tag/<?php echo $category['category_name_url']; ?>" <?php if(isset($category['color'])){ ?> style="background-color:<?php echo $category['color']; ?>" <?php } ?> >
