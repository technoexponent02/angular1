...
<div style="position:relative;">
	...
	<div class="row" ng-init="initializeMap()">
        ...
        <a href="" class="questionButtn btn btn-success btn-cons pull-right " ng-click="getGeoLocation()" ng-if="getLocationButtonStatus==true">Get my location</a>
...
<div class="row">
			...
			<div class="typefield">
                ...
                <div class="typefieldList">
                    <ul style="display:block; padding:0; margin:0;" >
                        ...
                        <li class="nw" ng-repeat="tag in fetchSearchTags" style="display:block;" ng-click="addSearchTag(tag.tag_name)" >
                         
                                    <span ng-bind-html="tag.tag_name | tagreplace" class="tagName" ng-if="!tag.question" ></span>
                                    ...
                                    <span class="userUNm" ng-if="tag.posts_count==0 &&  tag.users_count== 0" >{{'(new)'}}
    ...
    <div class="col-sm-12">
        <div class="form-group form-group-default noBorder">
            ...
            <div class="allCustomTags">
                <a ng-click="addTag(tag)" ng-repeat="tag in followingTags" id="following_tag_{{ tag.id }}" ng-init="isActive=checkActiveTag(tag)"  ng-class="{active : isActive}">{{tag.tag_name |tagreplace }}</a>
            </div>
        </div>
    </div>
</div>
...
<style>
	.typefield{position:relative;}
	.typefield .form-control{display:block; border-bottom:1px solid #e6e6e6;}
	.typefieldList{
		display: none;
		position: absolute;
		top: 100%;
    ...
    .jt-editor .jt-tag-new{
        display:none !important;
    }
    .typefieldList{max-height:305px !important;}
    .typefieldList .searchLoader{
        height:100%;
        min-height:40px;
    ...
    .typefieldList li{display:block !important;}
    .jt-tag {position:relative; padding-right:20px !important;}
    .jt-tag .remove-button{display:block; position:absolute; top:0; right:0;}
