...
<table style="width:429px; max-width:100%; margin:0 auto; font-family:Arial; margin:0 auto; font-size:16px; color:#29353b;" cellpadding="0" cellspacing="0">
    <tr>
            ...
            <table style="width:100%; max-width:100%;" cellpadding="10" cellspacing="0">
                ...
                <tr>
                    <td colspan="2" style="color:#3c3c3c; font-size:24px; line-height:26px;">
                        <strong>Welcome {{ $fullname }},<br/><span style="font-size:16px;">you’ve just
                                enrolled!</span></strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="color:#717f8c; font-size:15px; line-height:24px;">
                        Thanks for joining Swolk, you’re now one of us. We hope to see your participation in Swolk with the other members, please be kind to each other.
                    </td>
                </tr>
                <tr>
