            ...
            <table style="width:100%; max-width:100%;" cellpadding="10" cellspacing="0">
                ...
                <tr>
                    <td colspan="2" style="color:#3c3c3c; font-size:24px; line-height:26px;">
                        <strong>Comment ID {{ $comment->id }}<br/>
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="color:#3c3c3c; font-size:24px; line-height:26px;">
                        <strong>Post ID {{ $comment->post->id }}<br/>
                            <span style="font-size:16px;">{{ $comment->post->title ? $comment->post->title : $comment->post->caption }}</span>
                        </strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="color:#717f8c; font-size:15px; line-height:24px;">
                        Comment by : {{ $comment->user->first_name . ' ' . $comment->user->last_name }} / <a href="{{ url('profile/' . $comment->user->username) }}">{{ '@' . $comment->user->username }}</a>
                        <br/>
